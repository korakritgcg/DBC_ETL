"""
items.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Items
PK                     : No
"""
...
logger = get_logger("items_etl")

ODATA_PAGE = "Customers_list"
TABLE_NAME = "Customers_list"
SCHEMA = "raw"
PRIMARY_KEYS = ["No"]
...
def run_etl():
    logger.info("===== START ETL: Items (full load / batched) =====")
