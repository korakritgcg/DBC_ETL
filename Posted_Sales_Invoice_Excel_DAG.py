...
from DBC_ETL.Old.Posted_Sales_Invoice_Excel import run_etl
...
with DAG(
    dag_id='Posted_Sales_Invoice_Excel',
    ...
    run_task = PythonOperator(
        task_id='run_Posted_Sales_Invoice_Excel_etl',
        python_callable=run_etl,
        retries=2,
        retry_delay=timedelta(minutes=15),
        execution_timeout=timedelta(hours=5),
        pool='bc_full_heavy_pool',
        priority_weight=70,
    )
