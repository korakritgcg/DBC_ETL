...
EMBEDDED_SUPERMETRICS_API_URL = "https://api.supermetrics.com/enterprise/query/s/988789439f7611f197e042010a0820370fc90395062d943fccefe2b86ef00bbf/json"
...
def load_config(
    ...
    environ: Mapping[str, str] | None = None,
    *,
    api_url_env_name: str = 'SUPERMETRICS_API_URL',
) -> Config:
