"""
Item_Card.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Item_Card
PK                     : No
"""
...
logger = get_logger("Item_Card_etl")

ODATA_PAGE = "Item_Card"
TABLE_NAME = "Item_Card"
SCHEMA = "raw"
PRIMARY_KEYS = ["No"]
...
def run_etl():
    logger.info("===== START ETL: Item_Card (full load / batched) =====")
