"""
Consignment_Return_Order.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Consignment_Return_Order
PK                     : UBC_No
"""
...
logger = get_logger("Consignment_Return_Order_etl")

ODATA_PAGE = "Consignment_Return_Order"
TABLE_NAME = "Consignment_Return_Order"
SCHEMA = "raw"
PRIMARY_KEYS = ["UBC_No"]
...
def run_etl():
    logger.info("===== START ETL: Consignment_Return_Order (full load / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Consignment_Return_Order =====")
        return
