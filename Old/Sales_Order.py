"""
Sales_Order.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Sales_Order
PK                     : No
"""
...
def run_etl():
    logger.info("===== START ETL: Sales_Order (full load / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Sales_Order =====")
        return
