"""
Default_Dimenstions.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Default_Dimenstions
PK                     : Table_ID + No + Dimension_Code
"""
...
logger = get_logger("Default_Dimenstions_etl")

ODATA_PAGE = "Default_Dimenstions"
TABLE_NAME = "Default_Dimenstions"
SCHEMA = "raw"
PRIMARY_KEYS = ["Table_ID", "No", "Dimension_Code"]
...
def run_etl():
    logger.info("===== START ETL: Default_Dimenstions (full load / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Default_Dimenstions =====")
        return
