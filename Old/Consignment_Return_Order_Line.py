"""
Consignment_Return_Order_Line.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Consignment_Return_Order_Line
PK                     : UBC_Document_No + UBC_Line_No
"""
...
logger = get_logger("Consignment_Return_Order_Line_etl")

ODATA_PAGE = "Consignment_Return_Order_Line"
TABLE_NAME = "Consignment_Return_Order_Line"
SCHEMA = "raw"
PRIMARY_KEYS = ["UBC_Document_No", "UBC_Line_No"]
...
def run_etl():
    logger.info("===== START ETL: Consignment_Return_Order_Line (full load / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Consignment_Return_Order_Line =====")
        return
