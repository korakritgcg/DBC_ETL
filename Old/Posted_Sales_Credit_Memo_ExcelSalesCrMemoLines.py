"""
Posted_Sales_Credit_Memo_ExcelSalesCrMemoLines.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Posted_Sales_Credit_Memo_ExcelSalesCrMemoLines
...
logger = get_logger("Posted_Sales_Credit_Memo_ExcelSalesCrMemoLines_etl")

ODATA_PAGE = "Posted_Sales_Credit_Memo_ExcelSalesCrMemoLines"
TABLE_NAME = "Posted_Sales_Credit_Memo_ExcelSalesCrMemoLines"
SCHEMA = "raw"
...
def run_etl():
    logger.info(
        "===== START ETL: Posted_Sales_Credit_Memo_ExcelSalesCrMemoLines "
        "(full load / batched) ====="
    )
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Posted_Sales_Credit_Memo_ExcelSalesCrMemoLines =====")
        return
