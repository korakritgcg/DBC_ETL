"""
Table_Information.py — Full Refresh (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Table_Information
PK                     : Company_Name + Table_No
"""
...
logger = get_logger("Table_Information_etl")

ODATA_PAGE = "Table_Information"
TABLE_NAME = "Table_Information"
SCHEMA = "raw"
PRIMARY_KEYS = ["Company_Name", "Table_No"]
...
def run_etl():
    logger.info("===== START ETL: Table_Information (full refresh / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Table_Information =====")
        return
