"""
Page_posted_sales_credit_memo.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Page_posted_sales_credit_memo
PK                     : No
"""
...
logger = get_logger("Page_posted_sales_credit_memo_etl")

ODATA_PAGE = "Page_posted_sales_credit_memo"
TABLE_NAME = "Page_posted_sales_credit_memo"
SCHEMA = "raw"
PRIMARY_KEYS = ["No"]
...
def run_etl():
    logger.info("===== START ETL: Page_posted_sales_credit_memo (full load / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Page_posted_sales_credit_memo =====")
        return
