"""
Sales_Person.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Sales_Person
PK                     : Code
"""
...
logger = get_logger("Sales_Person_etl")

ODATA_PAGE = "Sales_Person"
...
def run_etl():
    logger.info("===== START ETL: Sales_Person (full load / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Sales_Person =====")
        return
