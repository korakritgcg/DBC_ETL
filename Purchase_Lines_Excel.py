"""
Purchase_Lines_Excel.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Purchase_Lines_Excel
...
logger = get_logger("Purchase_Lines_Excel_etl")

ODATA_PAGE = "Purchase_Lines_Excel"
TABLE_NAME = "Purchase_Lines_Excel"
SCHEMA = "raw"
...
def run_etl():
    logger.info("===== START ETL: Purchase_Lines_Excel (full load / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Purchase_Lines_Excel =====")
        return
