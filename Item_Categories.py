"""
Item_Categories.py — Full load (TRUNCATE once + batched APPEND).
OData page / SQL table : raw.Item_Categories
PK                     : Code
"""
...
logger = get_logger("Item_Categories_etl")

ODATA_PAGE = "Item_Categories"
...
def run_etl():
    logger.info("===== START ETL: Item_Categories (full load / batched) =====")
    ...
    if not table_truncated:
        ...
        logger.info("===== END ETL: Item_Categories =====")
        return
